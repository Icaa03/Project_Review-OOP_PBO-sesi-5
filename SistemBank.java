...
public class SistemBank {
    public static void main(String[] args) {
        ...
        Rekening rekening1 = new Tabungan("Ali", "12345", 1000000, 5.0);
        Rekening rekening2 = new Giro("Budi", "67890", 2000000, 500000);
        Rekening rekening3 = new Deposito("Citra", "11223", 1500000, 6, 7.0);
